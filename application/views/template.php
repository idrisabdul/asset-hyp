...
<head>
  ...
  <link rel="icon" href="<?= base_url() ?>assets/dist/img/Logo_Bumenet.png" type="image/gif">
...
<body class="hold-transition sidebar-mini sidebar-collapse">
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__shake" src="<?= base_url() ?>assets/dist/img/Logo_Bumenet.png" alt="Logo_Bumenet" height="60" width="60">
    </div>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        <img src="<?= base_url() ?>assets/dist/img/Logo_Bumenet.png" alt="Logo_Bumenet" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">B-Asset</span>
      </a>
