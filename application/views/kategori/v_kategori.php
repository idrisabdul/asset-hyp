        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <button data-toggle="modal" data-target="#addModal" class="btn btn-primary float-right"><i class="fas fa-plus"></i> Tambah Kategori</button>
                </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($all_kategori as $ak) { ?>
                                ...
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <?php
                                    if ($ak['type_kategori'] == 1) { ?>

                                        <td>Kategori</td>
                                    <?php } else { ?>
                                        <td>Lainnya</td>
                                    <?php } ?>
                                    <td><?= ucfirst($ak['nama_kategori']) ?></td>
                                    <td> <button href="#" id="editKategori" href="javascript:;" data-id="<?php echo $ak['kategoris_id'] ?>" data-nama_Kategori="<?php echo $ak['nama_kategori'] ?>" data-type_kategori="<?php echo $ak['type_kategori'] ?>" class="btn btn-xs btn-warning" data-toggle="modal" data-target="#edit"><i class="fa fa-edit mr-1"></i></button>
                                        <button onclick="deleteConfirm('<?= base_url('Kategori/delete/' . $ak['kategoris_id']) ?>')" class="btn btn-xs btn-danger" href="#!"><i class="fa fa-trash mr-1"></i></button>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
                ...
                <form action="<?= base_url('Kategori/insert_kategori') ?>" method="POST">
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            ...
                            <select class="custom-select rounded-0" id="type_kategori" name="type_kategori">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Kategori/EditKategori') ?>" method="POST">
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            <input type="hidden" name="id" id="id" class="form-control" placeholder="Masukkan Kategori" required />
